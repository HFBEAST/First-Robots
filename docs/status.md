...
先冻结六个核心协议的 v0 草案和行为测试；候选腕部相机研究保持与真机标定分离，不能再从中心投影、
射线或 raster 代理推断实体覆盖。待用户启用设备时，先建立带独立计划/record 的 Orbbec capture
smoke test，再开始标定或感知研究。MRBTP-demo 已完成上游 exploratory 自检；任何外部项目在与本项目
协议的正式证据建立前不得集成进产品源码。
